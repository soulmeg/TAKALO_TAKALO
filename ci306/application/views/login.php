...
<body>
    ...
    <?php echo isset($error) ? $error : ''; ?>      
        <form method="post" action="<?php echo site_url('Login/process'); ?>">
            ...
            <div class="form-group"><input class="form-control" type="user" name="email" placeholder="Email"></div>
            <div class="form-group"><input class="form-control" type="pass" name="password" placeholder="Password"></div>
